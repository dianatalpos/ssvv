...
public class Service {
    ...
    public int saveStudent(int id, String nume, int grupa) {
    ...
    public int saveTema(int id, String descriere, int deadline, int startline) {
    ...
    public int saveNota(int idStudent, Integer idTema, double valNota, int predata, String feedback) {
    ...
    public void createStudentFile(int idStudent, Integer idTema) {
